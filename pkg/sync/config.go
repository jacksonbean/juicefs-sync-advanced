...
type Config struct {
	...
	RecordPlanTableName      string
	RecordExtendedFields      bool
	RecordBatchSize          int
...
func NewConfigFromCli(c *cli.Context) *Config {
	...
	cfg := &Config{
		...
		RecordDBType:      c.String("record-db-type"),
		RecordDBDSN:       c.String("record-db-dsn"),
		RecordTableName:       c.String("record-table"),
		RecordPlanTableName:   c.String("record-plan-table"),
		RecordExtendedFields: c.Bool("record-extended-fields"),
		RecordBatchSize:   100,
